...
public class AgriengActivity extends AppCompatActivity {
	...
	private ArrayList<HashMap<String, Object>> AgriEngineering = new ArrayList<>();
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.agrieng);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		edittext1.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				ques.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
					public void onDataChange(DataSnapshot _dataSnapshot) {
						AgriEngineering = new ArrayList<>();
						try {
							GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
							for (DataSnapshot _data : _dataSnapshot.getChildren()) {
								HashMap<String, Object> _map = _data.getValue(_ind);
								AgriEngineering.add(_map);
							}
						}
						catch (Exception _e) {
							_e.printStackTrace();
						...
						if (_charSeq.length() > 0) {
							n = AgriEngineering.size() - 1;
							l = AgriEngineering.size();
							for(int _repeat20 = 0; _repeat20 < (int)(l); _repeat20++) {
								if (AgriEngineering.get((int)n).get("Question").toString().toLowerCase().contains(_charSeq.toLowerCase()) || "".toLowerCase().contains(_charSeq.toLowerCase())) {
									
								}
								else {
									AgriEngineering.remove((int)(n));
								}
								n--;
							}
						}
						listview1.setAdapter(new Listview1Adapter(AgriEngineering));
	...
	public void onBackPressed() {
		ques.removeEventListener(_ques_child_listener);
		finish();
	}
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _view, ViewGroup _viewGroup) {
			...
			View _v = _view;
			if (_v == null) {
				_v = _inflater.inflate(R.layout.agrieng_main, null);
			}
