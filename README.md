...
In our service only a particular services are open source i.e., the app code, there before using the app icon there must be proper approval from us before using it.
We may not be liable for any harm caused by using our service.
We don't provide any warranties regarding the use of service.
...
We don't use your cookies but the SDKs we use may collect the cookies.
