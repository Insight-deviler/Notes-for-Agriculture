...
public class StatisticsActivity extends AppCompatActivity {
	...
	private ArrayList<HashMap<String, Object>> STA = new ArrayList<>();
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						if (_charSeq.length() > 0) {
							...
							for(int _repeat20 = 0; _repeat20 < (int)(len); _repeat20++) {
								if (STA.get((int)num).get("Question").toString().toLowerCase().contains(_charSeq.toLowerCase()) || STA.get((int)num).get("Answer").toString().toLowerCase().contains(_charSeq.toLowerCase())) {
						...
						listview1.setAdapter(new Listview1Adapter(STA));
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _view, ViewGroup _viewGroup) {
			...
			View _v = _view;
			if (_v == null) {
				_v = _inflater.inflate(R.layout.sta_main, null);
			}
			...
			textview3.setText(STA.get((int)_position).get("Question").toString());
			textview4.setText(STA.get((int)_position).get("Answer").toString());
