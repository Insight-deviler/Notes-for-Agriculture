...
public class SoilScienceActivity extends AppCompatActivity {
	...
	private ArrayList<HashMap<String, Object>> SAC = new ArrayList<>();
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.soil_science);
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						if (_charSeq.length() > 0) {
							...
							for(int _repeat20 = 0; _repeat20 < (int)(len); _repeat20++) {
								if (SAC.get((int)num).get("Question").toString().toLowerCase().contains(_charSeq.toLowerCase()) || SAC.get((int)num).get("Answer").toString().toLowerCase().contains(_charSeq.toLowerCase())) {
						...
						listview1.setAdapter(new Listview1Adapter(SAC));
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _view, ViewGroup _viewGroup) {
			...
			View _v = _view;
			if (_v == null) {
				_v = _inflater.inflate(R.layout.sac_main, null);
			}
			...
			textview3.setText(SAC.get((int)_position).get("Question").toString());
			textview4.setText(SAC.get((int)_position).get("Answer").toString());
