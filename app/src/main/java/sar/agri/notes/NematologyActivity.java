...
public class NematologyActivity extends AppCompatActivity {
	...
	private ArrayList<HashMap<String, Object>> Nem = new ArrayList<>();
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.nematology);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		edittext1.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				Nematology.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						if (_charSeq.length() > 0) {
							...
							for(int _repeat20 = 0; _repeat20 < (int)(Len); _repeat20++) {
								if (Nem.get((int)Num).get("Question").toString().toLowerCase().contains(_charSeq.toLowerCase()) || Nem.get((int)Num).get("Answer").toString().toLowerCase().contains(_charSeq.toLowerCase())) {
						...
						listview1.setAdapter(new Listview1Adapter(Nem));
	...
	public void onBackPressed() {
		Nematology.removeEventListener(_Nematology_child_listener);
		finish();
	}
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _view, ViewGroup _viewGroup) {
			...
			View _v = _view;
			if (_v == null) {
				_v = _inflater.inflate(R.layout.nem_main, null);
			}
			...
			textview3.setText(Nem.get((int)_position).get("Question").toString());
			textview4.setText(Nem.get((int)_position).get("Answer").toString());
